...
export default function ApartmentDetail() {
  ...
  const getFeatureIcon = (feature: string) => {
    ...
    const iconMap: Record<string, JSX.Element> = {
      ...
      "Asciugacapelli": <Zap className="h-4 w-4" />,
      "Asciugamani": <Bath className="h-4 w-4" />,
      "Barbecue": <Flame className="h-4 w-4" />,
      "Bollitore": <Zap className="h-4 w-4" />,
      ...
      "Lavastoviglie": <UtensilsCrossed className="h-4 w-4" />,
      ...
      "Hair dryer": <Zap className="h-4 w-4" />,
      "Towels": <Bath className="h-4 w-4" />,
      "Kettle": <Zap className="h-4 w-4" />,
